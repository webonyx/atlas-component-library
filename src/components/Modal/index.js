...
const Modal = ({ title, children, footer, show, onHide, onSave, onCancel, backdrop, ...props }) => {
  let footerComponent = (
    <React.Fragment>
  ...
  return (
    <BModal show={show} onHide={onHide} backdrop={backdrop || 'static'} keyboard={backdrop === true} {...props}>
